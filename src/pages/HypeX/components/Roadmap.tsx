...
const RoadMap = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <h2 className="md:text-[3.8rem] text-white md:leading-[4rem] mb-8 md:mb-20 text-xl font-black">
        Roadmap
      </h2>
...
const RoadmapCard = ({
  ...
  return (
    <div className="relative flex flex-col p-6 text-white border border-transparent border-white bg-clip-border rounded-xl w-[23rem]">
      ...
      <h3 className="md:text-[2rem] text-3xl font-bold mb-5">{title}</h3>
      <span className="w-20 h-[1px] bg-gray-200"></span>
      ...
      <CustomButton className="absolute rotate-[20deg] right-5 rounded-full">
        <span>{q}</span>
      </CustomButton>
    </div>
  );
